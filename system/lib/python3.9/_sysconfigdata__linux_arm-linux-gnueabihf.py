...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/system/bin',
 'BINLIBDEST': '/system/lib/python3.9',
 'BLDLIBRARY': 'libpython3.9.a',
 'BLDSHARED': 'arm-linux-gnueabihf-gcc -pthread -shared -pie -static',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'arm-unknown-linux-gnueabihf',
 'BYTESTR_DEPS': '\\',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-pie -static',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--target=arm-linux-gnueabihf' '--build=arm-linux-gnueabihf' "
                "'CC=arm-linux-gnueabihf-gcc' 'LD=arm-linux-gnueabihf-ld' "
                "'AR=arm-linux-gnueabihf-ar' 'CFLAGS=-pie -static' "
                "'LDFLAGS=-pie -static' 'CXXFLAGS=-pie -static' "
                "'--prefix=/system' 'build_alias=arm-linux-gnueabihf' "
                "'target_alias=arm-linux-gnueabihf'",
 'CONFINCLUDEDIR': '/system/include',
 'CONFINCLUDEPY': '/system/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/bobthebuilder/Desktop/linux/python-3.9.0/coverage.info',
 'COVERAGE_REPORT': '/home/bobthebuilder/Desktop/linux/python-3.9.0/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'c++ -pthread',
 'DESTDIRS': '/system /system/lib /system/lib/python3.9 '
             '/system/lib/python3.9/lib-dynload',
 'DESTLIB': '/system/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/system/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/system/include /system/include /system/include/python3.9 '
                   '/system/include/python3.9',
 'INCLUDEDIR': '/system/include',
 'INCLUDEPY': '/system/include/python3.9',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'arm-linux-gnueabihf-gcc -pthread -shared -pie -static',
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/system/lib/python3.9',
 'LIBDIR': '/system/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/system/lib/pkgconfig',
 'LIBPL': '/system/lib/python3.9/config-3.9-arm-linux-gnueabihf',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/system/lib/python3.9',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g '
                             '-fwrapv -O3 -Wall -pie -static -std=c99 -Wextra '
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-39-arm-linux-gnueabihf',
 ...
 'abs_builddir': '/home/bobthebuilder/Desktop/linux/python-3.9.0',
 'abs_srcdir': '/home/bobthebuilder/Desktop/linux/python-3.9.0',
